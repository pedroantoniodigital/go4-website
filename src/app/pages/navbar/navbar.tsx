    ...
    <div className="fixed bg-white w-full h-20 z-40 justify-between">
      <div className="flex justify-between mt-7 h-6 gap-10 bg-white w-full px-4"> 
        <div className="flex flex-row items-center gap-10">
          <img className="max-w-full w-16 h-12" src="/static/images/go4-icon-azul.png" alt="image description"/>
        ...
        <div className="flex flex-row items-center gap-10">
          <button className='flex flex-row w-full md:w-72 h-[50px] rounded-[100px] bg-primary-light drop-shadow-theme'>
