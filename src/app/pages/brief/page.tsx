...
const Brief = () => (
  <main className="min-h-screen w-full h-fit-content flex flex-col items-center justify-center m-0 py-20 bg-white">
    <div className="flex flex-wrap justify-center w-100% md:w-[70%] gap-8">
      ...
      <div className="border-[1px] mt-[-100px] border-gray-200 hover:shadow-card transition-all duration-500 cursor-pointer w-[100%] md:w-[28%] rounded-lg h-fit p-8">
        <div className="text-gray-900 font-medium mt-6 w-[100%]">
          Lorem ipsum dolor sit amet,
          consectetur adipiscing elit.
          Vestibulum vitae diam neque.
      ...
      <div className="border-[1px] mt-[-60px] border-gray-200 hover:shadow-card transition-all duration-500 cursor-pointer w-[100%] md:w-[28%] rounded-lg h-fit p-8">
        <div className="text-gray-900 font-medium mt-6 w-[100%]">
          Lorem ipsum dolor sit amet,
          consectetur adipiscing elit.
          Vestibulum vitae diam neque.
      ...
      <div className="border-[1px] mt-[-80px] border-gray-200 hover:shadow-card transition-all duration-500 cursor-pointer w-[100%] md:w-[28%] rounded-lg h-fit p-8">
        <div className="text-gray-900 font-medium mt-6 w-[100%]">
          Lorem ipsum dolor sit amet,
          consectetur adipiscing elit.
          Vestibulum vitae diam neque.
